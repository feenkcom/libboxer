...
#[no_mangle]
pub fn boxer_point_i32_drop(ptr: *mut ValueBox<BoxerPointI32>) {
    BoxerPointI32::boxer_point_drop(ptr);
}

#[no_mangle]
pub fn boxer_point_i32_get_x(point_ptr: *mut ValueBox<BoxerPointI32>) -> i32 {
    BoxerPointI32::boxer_point_get_x(point_ptr)
}

#[no_mangle]
pub fn boxer_point_i32_set_x(point_ptr: *mut ValueBox<BoxerPointI32>, x: i32) {
    BoxerPointI32::boxer_point_set_x(point_ptr, x);
}

#[no_mangle]
pub fn boxer_point_i32_get_y(point_ptr: *mut ValueBox<BoxerPointI32>) -> i32 {
